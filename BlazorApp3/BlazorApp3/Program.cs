...
using BlazorApp3.Domain; // Use Domain for the User class
...
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(BlazorApp3.Application.IApplicationMarker).Assembly));
